        ...
        <aside>
    		...
    		// 기본 월 자료 사용
        		...
        		//} else if($vrfyType == 'shrt_ts_grd' || $vrfyType == 'medm_ts_grd') {
                    ...
                    $this->load->view('common/content_map'); 
                } else if($vrfyType == 'gemd_ts_similarity') {
                    $this->load->view('main/ts_similarity'); 
                    $this->load->view('common/topMenu/top_ts_similarity'); 
                    $this->load->view('common/content');
                } else if($vrfyType == 'gemd_ts_accuracy') {
                    $this->load->view('main/ts_accuracy'); 
                    $this->load->view('common/topMenu/top_ts_accuracy'); 
                    $this->load->view('common/content');
                } else if($vrfyType == 'gemd_map_utilize') {
                    $this->load->view('main/map_utilize'); 
                    $this->load->view('common/topMenu/top_map_utilize'); 
                    $this->load->view('common/content');
                }
                ?>
