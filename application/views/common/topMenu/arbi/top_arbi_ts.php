...
<section class="top_wrapper">
    <div class="containter" style="height:100%;">
        <div class="dateSelect" >
            ...
            <div class="btn-group">
            	<button id="plotBtn"  class="btn btn-primary btn-xs" type="button" style="margin-left:20px;" onclick="getDataArray();">PLOT</button>
            	<!-- <button id="plotBtn" type="button" style="margin-left:20px;" onclick="">PLOT</button> -->
            </div>
    	</div>
