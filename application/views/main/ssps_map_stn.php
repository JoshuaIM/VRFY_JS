...
var keydown_cont = 0;
    ...
    function getDataArray() {
    	...
    	callAjaxUtcInfo(data_head, var_select, init_hour, start_init, end_init, vrfy_idx, peri);
...
//  예측기간별 자료  Ajax 이용 그래픽 표출 메서드.
	function callAjaxUtcInfo(data_head, var_select, init_hour, start_init, end_init, vrfy_idx, peri) {
...
// console.log(resp);
					...
					if( resp["fcst_info"] ) {
						...
						display_grph(var_change, ["SSPS"], vrfy_idx, resp, idx, data_head);
