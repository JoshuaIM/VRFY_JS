...
<!-- // 방재기간 관련 함수 -->
	...
	<script src="<?php echo base_url('assets/js/vrfy_js/highcharts/bangjae_accuracy_ajax.js');?>"></script>

<!-- // 계절별 관련 함수 -->
	<script src="<?php echo base_url('assets/js/vrfy_js/highcharts/season_accuracy_ajax.js');?>"></script>

<!-- // 전체기간 관련 함수 -->
	<script src="<?php echo base_url('assets/js/vrfy_js/highcharts/allmonth_accuracy_ajax.js');?>"></script>

<!-- // fcst ajax 및 집계표 공통함수 분리 -->
	<script src="<?php echo base_url('assets/js/vrfy_js/highcharts/fcst_accuracy_ajax.js');?>"></script>
...
console.log('var_select', var_select);
		...
		// model_sel.push("BEST_MERG");
		// $("input[name=MODEL_TECH]").prop("checked", false);
		// $("input[name=MODEL_TECH][value='BEST_MERG']").prop("checked", true);
        ...
        if( peri == "FCST" ) {
    		const ajax_url_fcst = '<?php echo site_url();?>/main/getAccuraryFcstData';
    		...
    		const ajax_url_bangjae = '<?php echo site_url();?>/main/getGemdAccuraryBangjaeData';
			callAjaxBangjaeData(ajax_url_bangjae, data_head, var_select, init_hour, model_sel, location, peri, bangjae_date, vrfy_idx);
        } else if( peri == "SEASON" ) {
    		const ajax_url_season = '<?php echo site_url();?>/main/getGemdAccurarySeasonData';
    		...
    		const ajax_url_allmonth = '<?php echo site_url();?>/main/getGemdAccuraryAllmonthData';
