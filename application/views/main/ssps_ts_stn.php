...
let glob_data = new Array();
    ...
    function getDataArray() {
        ...
        if( peri == "FCST" ) {
    		callAjaxFcstData(data_head, var_select, init_hour, location, start_init, end_init, vrfy_idx);
        } else if( peri == "MONTH" ) {
    		callAjaxMonthData(data_head, var_select, init_hour, location, start_init, end_init, vrfy_idx);
        }
...
//  예측기간별 자료  Ajax 이용 그래픽 표출 메서드.
	function callAjaxFcstData(data_head, var_select, init_hour, location, start_init, end_init, vrfy_idx) {
...
//  월별 자료  Ajax 이용 그래픽 표출 메서드.
	function callAjaxMonthData(data_head, var_select, init_hour, location, start_init, end_init, vrfy_idx) {
...
<div id="sidebar_sub">
    ...
    <div class="sidebar-toggle-box" style="float:left; margin-top:10px; margin-left: 7%;">
    	...
    	<div class="subMenu_nav">
        	<b style="font-size:15px;" ><?php echo $vrfyTypeName[0]; ?> <i class="fa fa-link" style="font-size:13px"></i> <?php echo $vrfyTypeName[1]; ?>(<?php echo $vrfyTypeName[2]; ?>)</b>
    	</div>
    </div>
