...
function setSubLocation(selectValue) {
	...
	const variable = $("select[name=VAR]").val();
...
// // 					if( l_id === "108" || l_id === "102" || l_id === "112" || l_id === "119" || l_id === "133" || l_id === "177" || l_id === "93" || l_id === "104" || l_id === "115" || l_id === "136" || l_id === "138" || l_id === "143" || l_id === "159" || l_id === "152" || l_id === "155" || l_id === "146" || l_id === "156" || l_id === "165" || l_id === "169" || l_id === "168" || l_id === "189" || l_id === "184" ) {
// // 						var l_txt = get_station_name( splitValue[sp] );
// // console.log('l_txt', l_txt);
